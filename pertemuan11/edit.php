            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="mt-4">Update Data Barang</h2>
                    </div>
                    <div class="card-body">
                        <form method="post" action="proses_barang.php?action=update">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_barang" name="nama_barang" value="<?php echo $data_barang['nama_barang']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="harga_beli" name="harga_beli" value="<?php echo $data_barang['harga_beli']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="harga_jual" class="col-sm-2 col-form-label">Harga Jual</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="harga_jual" name="harga_jual" value="<?php echo $data_barang['harga_jual']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
