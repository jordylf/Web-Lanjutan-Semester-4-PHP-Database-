...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <p style="padding-right: 30px;">NO. 2</p>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Perulangan Dinamis</h5>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            if (isset($_POST["start"]) && isset($_POST["end"])) {
                                ...
                                echo "<div class='alert alert-danger mt-3'>Silakan masukkan angka awal dan angka akhir.</div>";
                            }
                        }
                        ?>
                    </div>
