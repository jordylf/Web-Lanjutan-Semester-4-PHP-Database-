...
document.getElementById("buy-ticket-btn").addEventListener("click", function (event) {
    event.preventDefault(); // Prevent default link behavior

    // Jumlah tiket yang ingin ditambahkan
    var quantity = 1; // Misalnya, tambahkan 1 tiket setiap kali tombol diklik

    // Simpan jumlah tiket ke keranjang, bisa menggunakan local storage atau metode lainnya
