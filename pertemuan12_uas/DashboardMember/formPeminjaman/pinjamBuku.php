...
// Cek apakah user sudah login, jika belum redirect ke halaman sign in
...
// Query untuk mengambil data siswa yang sedang login
...
if (isset($_POST["pinjam"])) {
    // Memanggil fungsi pinjamBuku dari file config.php
...
<body>
    ...
    <div class="p-4 mt-5">
        <h2 class="mt-5 text-center fw-bold">Form Peminjaman Buku</h2>

        <!-- Card Data Lengkap Buku -->
        <div class="card col-10 mx-auto mt-4">
            ...
            <div class="card-body d-flex flex-wrap gap-5 justify-content-center">
                <?php foreach ($query as $item) : ?>
                    <p class="card-text"><img src="../../imgDB/<?= $item["cover"]; ?>" width="300px" style="border-radius: 10px;"></p>
                    <form action="" method="post">
                        <!-- Input Group untuk Data Buku -->
        ...
        <div class="alert alert-danger mt-4 col-10 mx-auto" role="alert">Silahkan periksa kembali data diatas, pastikan sudah benar sebelum meminjam buku!. jika ada kesalahan data harap hubungi admin</div>

        <!-- Card Form Pinjam Buku -->
        <div class="card col-10 mx-auto mt-4">
        ...
        <div class="alert alert-danger mt-4 col-10 mx-auto" role="alert">
