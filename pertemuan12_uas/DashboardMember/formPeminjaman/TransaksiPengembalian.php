...
$akunMember = $_SESSION["member"]["nisn"]; // Mendapatkan NISN dari sesi pengguna
...
// Memproses pencarian jika tombol "search" diklik
if (isset($_POST["search"])) {
  $dataPengembalian = search($_POST["keyword"]); // Memanggil fungsi search dengan keyword yang dikirimkan
}
?>
...
<body>
  ...
  <div class="p-4 mt-5">
    <h1 class="text-center fw-bold mt-5">Menu - <span class="text-danger">Pengembalian</span></h1>
    <div class="mt-5 alert alert-primary alert-custom text-center" role="alert">Riwayat transaksi Pengembalian Buku Anda - <span class="fw-bold text-capitalize"><?php echo htmlentities($_SESSION["member"]["nama"]); ?></span></div>
