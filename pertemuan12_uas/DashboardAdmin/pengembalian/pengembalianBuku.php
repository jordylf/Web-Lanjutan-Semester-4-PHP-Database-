...
// Query untuk mengambil data pengembalian buku beserta informasi buku, member, dan admin yang terlibat
...
<body>
  ...
  <div class="p-4 mt-5">
    <div class="mt-5">
      <h1 class="text-center fw-bold mt-5">Menu Admin - <span class="text-danger">List of Pengembalian</span></h1> <!-- Judul halaman -->
      <div class="mt-5 alert alert-primary alert-custom text-center" role="alert">List Member yang sudah Mengembalikan</div> <!-- Alert untuk informasi -->
        ...
        <table class="table table-striped table-hover table-custom">
          ...
          <?php foreach ($dataPeminjam as $item) : ?>
            <tr>
              ...
              <td>
                <div class="action">
                  <a href="deletePengembalian.php?id=<?= $item["id_pengembalian"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ?');"><i class="fa-solid fa-trash"></i></a> <!-- Tombol delete dengan konfirmasi -->
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
