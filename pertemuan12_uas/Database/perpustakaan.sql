...
--
-- Host: localhost:3306
-- Generation Time: Jun 18, 2024 at 02:00 PM
...
(1, 'Afri Yudha', '123', 'admin1', '085746729032');
...
('666ddf555c3a3.jpg', 'bis02', 'bisnis', 'Digital Marketing Strategy', 'Simon kings north', '-', '2023-11-11', 250, 'Belajar strategi pemasaran digital.'),
('666c524f9ec80.jpg', 'fil01', 'filsafat', 'Filosofi Teras', 'Henry Manampiring ', 'Kompas', '2018-11-26', 320, 'Filosofi Teras adalah sebuah buku pengantar filsafat Stoa yang dibuat khusus sebagai panduan moral anak muda. Buku ini ditulis untuk menjawab permasalahan tentang tingkat kekhawatiran yang cukup tinggi dalam skala nasional, terutama yang dialami oleh anak muda.'),
...
(2022230009, 'mem01', 'jordy lianferdinand', '$2y$10$Wi4BlksBvp74qv9roovPMemPsJj90KFGwNuyl19lTREMFcEZfPAsS', 'Laki laki', 'X', 'Desain Komunikasi Visual', '21313131', '2024-06-14');
...
(79, 97, 'fil01', 2022230009, 1, '2024-06-16', 'TIDAK', 0),
(80, 98, 'fil02', 2022230009, 1, '2024-06-24', 'YA', 0);
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT for table `pengembalian`
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
